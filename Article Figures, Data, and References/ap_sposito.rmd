...
#ggsave("figure1.png", units="in", width=11, height=11, dpi = 500)
...
#ggsave("figure2.png", units="in", width=11, height=11, dpi = 500)
...
aut_perf_set_long_ap <- rbind(aut_perf_set_long, aut_perf_set_long_BR) %>% 
 mutate(Setting = factor(case_when(setting == 'interviews' ~ "Interviews",
  ...
  levels = c("Official Speeches", "Campaign Remarks",
   "Debates", "Interviews")))
#ggsave("figure3.png", units="in", width=11, height=11, dpi = 500)
...
#ggsave("figure4.png", units="in", width=11, height=11, dpi = 500)
...
BR_model_div <- plm(diversity ~ status + party,
  data = BR_mod, model = "within", index = c("year"))
#ggsave("figure5.png", units="in", width=11, height=11, dpi = 500)
