...
csl: chicago.csl
abstract: Political authenticity, as the perceived degree to which politicians appear to remain true to themselves, is connected to higher levels of political trust from electorates and can influence political outcomes. Despite this, authenticity is frequently overlooked as a determinant factor for electoral behavior due to its perceived vagueness. When authenticity is considered, discussions of how authenticity appears and changes in politics typically remain at the theoretical level and are rarely comparative. This article develops an innovative framework to identify and compare how authenticity is performed in political discourses over time, across settings, and by politicians. To investigate performances of authenticity in political discourses, 21496 political texts from campaign remarks, debates, interviews, and official speeches for presidents and presidential candidates since 1988 were scraped for Brazil and the United States, where authenticity in politics has drawn increased attention. The findings indicate that authenticity performances are not more prevalent during election years. Authenticity is generally performed more frequently and more diverse ways in Brazil than in the US.
---
...
```{=latex}
\wordcount{9000 (includes text, tables, figures, and notes)}
```
...
The linear regression, above, correlates the total of authenticity performances to election cycles in Brazil and confirms statistically significant increases for the cycle when Rousseff was president.
...
The relationship between the average frequencies of authenticity performances category and setting is investigated employing fixed-effects models, above.The correlation between the frequencies of authenticity performances and campaign settings for the US, in comparison to official speeches (reference category), is positive and highly statistically significant. Interviews also appear to correlate positively with authenticity performances in the US, in comparison to official speeches. In the case of Brazil, both campaign and debate settings correlate positively with authenticity performances in relation to official speeches.
...
The same models were also run controling for settings and add interactions between status and the category of authenticity performances. However, there were not many statistically significant relationships and the significance or the direction of the relationships displayed in the model above remained similar.
