...
```{=latex}
\wordcount{8966 (includes text, tables, figures, and notes)}
```
...
````{=tex}
```{r table 4, fig.cap="Table 5 - Authenticity Performances and Election Years in Brazil and the US", echo=FALSE, message=FALSE, warning=FALSE, paged.print=TRUE, include=TRUE, results="asis"}
...
````{=tex}
```{r table 6, fig.cap="Table 6 - Average Normalized Proportion of Authenticity Performances in Brazil and the US (for every 1000 words)", echo=FALSE, message=FALSE, warning=FALSE, paged.print=TRUE, include=TRUE, results="asis"}
...
````{=tex}
```{r table 7, fig.cap="Table 7 - Authenticity Performances by Setting in Brazil and the US", echo=FALSE, message=FALSE, warning=FALSE, paged.print=TRUE, include=TRUE, results="asis"}
